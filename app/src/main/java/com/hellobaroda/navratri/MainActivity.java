...
public class MainActivity extends Activity {
    ...
    void home(){
        ...
        addSpace(16);rowTitle("Popular Garba Grounds","See all",v->grounds());loadGroundPreview();addSpace(16);rowTitle("Community moments","View trending",v->trending());loadPosts(false);
    }
