...
public class MainActivity2 extends Activity {
    ...
    private void injectPurchaseBridge() {
        String js = "(function(){"
                ...
                + "window.onPlayPurchaseVerified=function(id){const c=typeof catalog!=='undefined'?catalog:[];const e=c.flatMap(x=>(x.seasons||[]).flatMap(s=>s.episodes||[])).find(x=>x.id===id);if(e&&e.video_url&&window.Android){Android.playVideo(e.title||'Asia Drama',e.video_url,0);}};"
